...
@section('content')
    ...
    <div class=" my-3 d-flex justify-content-between">
        ...
        <div class=" d-flex align-items-center">
            ...
            <div class=" me-2">
                <a href="{{ route('categorizedShow',[$category->id,'name' => 'asc']) }}">asc</a>
            <a href="{{ route('categorizedShow',[$category->id,'name' => 'desc']) }}">desc</a>
            <a href="{{ route('categorizedShow',$category->id) }}">default</a>
            </div>
