...
@section('content')
    ...
    <div class=" my-3 d-flex justify-content-between">
        ...
        <div class=" d-flex align-items-center">
            ...
            <div class=" me-2">
                <a href="{{ route('indexFav',['name' => 'asc']) }}">asc</a>
            <a href="{{ route('indexFav',['name' => 'desc']) }}">desc</a>
            <a href="{{ route('indexFav') }}">default</a>
            </div>
            ...
            <div>
                <form action="" class="" method="get">
                    <div class=" input-group">
                        ...
                        <a href="{{ route('indexFav') }}" class=" btn btn-outline-danger">x</a>
